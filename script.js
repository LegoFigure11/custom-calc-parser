...
9	- Move Name
  ...
  */
  	...
  	customFormat = {
		...
		var ln16p2 = IVs[4]
		var ln17p2 = IVs[5]
		var move1 = moves.substring(moves.indexOf(',')).trim();
		var move2 = moves.substring(moves.indexOf(',')+1).trim();
		var move3 = moves.substring(moves.indexOf(',')+2).trim();
		var move4 = moves.substring(moves.indexOf(',')+3).trim();
